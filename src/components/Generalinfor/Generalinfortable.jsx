...
export default function Generalinfortable({handleEdit , handleDelete , data}) {
        ...
        <TableBody>
          {(rowsPerPage > 0
            ...
            <TableRow key={index}>
              ...
              <TableCell component="th" scope="row">
               { row?.fieldsofStudyNumber}
              </TableCell>            
              
              <TableCell component="th" scope="row">
               { row?.independentResearchersNumber}
              </TableCell>            
              
              <TableCell component="th" scope="row">
               { row?.jointTrainingNumber}
              </TableCell>            
              <TableCell component="th" scope="row">
               { row?.proffessorNumber}
              </TableCell>            
              <TableCell component="th" scope="row">
               { row?.studentsNumber}
              </TableCell>            
