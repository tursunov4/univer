...
export default function Newsdaytable({handleEdit , handleDelete , data}) {
  ...
  <Button onClick={()=>setLan("kr")}>Kr</Button>
      ...
      <TableHead>
          <TableRow>
             ...
             <TableCell>
              {
              lan === "uz" &&"shortdescriptionUZ"
              }
              {
              lan === "ru" &&"shortdescriptionRU"
              }
              {
              lan === "en" &&"shortdescriptionEN"
              }
              {
              lan === "kr" &&"shortdescriptionKR"
              }
             </TableCell>
        ...
        <TableBody>
          {(rowsPerPage > 0
            ...
            <TableRow key={index}>
              ...
              <TableCell component="th" scope="row">
                {  lan ==="en" && row?.shortdescriptionEN}
                {  lan ==="ru" && row?.shortdescriptionRU}
                {  lan ==="uz" && row?.shortdescriptionUZ}
                {  lan ==="kr" && row?.shortdescriptionKR}
              </TableCell>            
              <TableCell component="th" scope="row">               
                    <p key={index}>
                      {row?.attachDto?.orginalName}
                    </p>
              </TableCell>  
              <TableCell >
