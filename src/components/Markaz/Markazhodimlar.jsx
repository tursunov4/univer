...
export default function MarkazhodimTable({ handleEdit, handleDelete, data }) {
        ...
        <Table style={{ width: "180vw" }} aria-label="custom pagination table">
          <TableHead>
            <TableRow>
              ...
              <TableCell>Markaz nomi</TableCell>
              <TableCell>
                {lan === "uz" && "biographyUZ"}
                {lan === "ru" && "biographyRU"}
                {lan === "en" && "biographyEN"}
          ...
          <TableBody>
            {(rowsPerPage > 0
              ...
              <TableRow key={index}>
                ...
                <TableCell component="th" scope="row">
                  {lan === "en" && row?.positionEN}
                  {lan === "ru" && row?.positionRU}
                  {lan === "uz" && row?.positionUZ}
                  {lan === "kr" && row?.positionKR}
                </TableCell>
                <TableCell component="th" scope="row">
                  <p
                    style={{
