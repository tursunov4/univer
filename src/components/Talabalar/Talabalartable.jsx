...
export default function TalabaTable({handleEdit , handleDelete , data}) {
        ...
        <TableBody>
          {(rowsPerPage > 0
            ...
            <TableRow key={index}>
              ...
              <TableCell component="th" scope="row">
                {  lan ==="en" && row?.directionEN}
                {  lan ==="ru" && row?.directionRU}
                {  lan ==="uz" && row?.directionUZ}
                {  lan ==="kr" && row?.directionKR}
              </TableCell> 
              <TableCell component="th" scope="row">
