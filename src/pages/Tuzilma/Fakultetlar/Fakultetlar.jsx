...
const Fakultetlar = () => {
 ...
 const handleSubmit =()=>{
  ...
  if(edit){
    http.put(`/api/user/editFaculty/${editid}` , {
        hashid:arr?.at(-1),
...
const deleteData =(id)=>{
  ...
  const handleEdit =(data)=>{
    ...
    setMoliyaSelection(data?.leadership?.id )
...
useEffect(()=>{
  ...
  return (
    ...
    <Fakultettable handleEdit={handleEdit} data={allData} handleDelete={deleteData}/>
    ...
    >
      <Box  sx={style}>
         <h2 className='elontitle'>Fakultet {edit ? "tahrirlash" : "qo'shish"}</h2>
        ...
        />
          ...
          <InputLabel id="demo-simple-select-label">Fakultet rahbarlari</InputLabel>
        <Select
