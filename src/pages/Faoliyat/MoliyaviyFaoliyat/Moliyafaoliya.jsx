...
const Moliyafaoliyat = () => {
 ...
 const handleSubmit =()=>{
  ...
  if(edit){
    ...
    http.post("/api/user/addFinancialDocuments" , {
        hashId:arr?.at(-1),
        informationEN: descriptionen,
        informationKR: descriptionkr,
        informationRU: descriptionru,
...
const getData =()=>{
  http.get("/api/public/allFinancialDocuments" ).then((res) =>{
    console.log(res.data)
    setAlldata(res.data)
  }).catch((err)=>{
    console.log(err)
...
const deleteData =(id)=>{
  http.delete(`/api/user/deleteFinancialDocuments/${id}`).then((res) =>{
    console.log(res.data)
    if(res.data?.success){
  ...
  const handleEdit =(data)=>{
    ...
    setMoliyaSelection(data?.financialOperationsDepartmentId)
  ...
  const getMoliyaType =()=>{
    http.get("/api/public/allfinancialOperationsDepartment" ).then((res) =>{
      console.log(res.data)
