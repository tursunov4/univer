...
const Moliyafaoliyat = () => {
  ...
  const handleSubmit = () => {
    ...
    if (edit) {
      http
        .put(`/api/user/editFinancialDocuments/${editid}`, {
          hashId: arr?.at(-1),
      ...
      http
        .post("/api/user/addFinancialDocuments", {
          hashId: arr?.at(-1),
          informationEN: descriptionen,
          informationKR: descriptionkr,
          informationRU: descriptionru,
  ...
  const getData = () => {
    http
      .get("/api/public/allFinancialDocuments")
      .then((res) => {
        console.log(res.data);
        setAlldata(res.data);
      })
  ...
  const deleteData = (id) => {
    http
      .delete(`/api/user/deleteFinancialDocuments/${id}`)
      .then((res) => {
        console.log(res.data);
        if (res.data?.success) {
