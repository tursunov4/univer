...
const Moliyatype = () => {
 ...
 const handleSubmit =()=>{
  ...
  if(edit){
    http.put(`/api/user/editFinancialOperationsDepartment/${editid}` , {
        nameKR: titleKr,
        nameRU: titleRu,
        nameUZ: titleUz,
        nameEN: titleEn,
    ...
    http.post("/api/user/addFinancialOperationsDepartment" , {
        nameKR: titleKr,
        nameRU: titleRu,
        nameUZ: titleUz,
        nameEN: titleEn,
...
const deleteData =(id)=>{
  http.delete(`/api/user/deleteFinancialOperationsDepartment/${id}`).then((res) =>{
    console.log(res.data)
    if(res.data?.success){
...
useEffect(()=>{
  ...
  return (
    ...
    <MoliyaTable handleEdit={handleEdit} data={allData} handleDelete={deleteData}/>
