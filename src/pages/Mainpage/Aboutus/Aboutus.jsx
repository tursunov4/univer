...
const Aboutus = () => {
 ...
 const handleSubmit =()=>{
  ...
  if(edit){
    http.put(`/api/user/editAboutInstituti/${editid}` , {
    ...
    http.post("/api/user/aboutInstituti" , {
      descriptionEN: descriptionen,
      descriptionKR: descriptionkr,
      descriptionRU: descriptionru,
      descriptionUZ: descriptionuz,
...
const getData =()=>{
  http.get("/api/public/getAboutInstitutiall" ).then((res) =>{
    console.log(res.data)
    setAlldata(res.data)
  }).catch((err)=>{
    console.log(err)
...
const deleteData =(id)=>{
  http.delete(`/api/admin/deleteAboutInstituti/${id}`).then((res) =>{
    console.log(res.data)
    if(res.data?.success){
