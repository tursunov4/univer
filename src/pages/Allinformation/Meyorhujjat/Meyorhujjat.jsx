...
const Meyoriyhujjat = () => {
  ...
  const handleSubmit = () => {
    ...
    if (edit) {
      http
        .put(`/api/user/editRegulationdocument/${editid}`, {
          hashId: arr?.at(-1),
          nameKR: titleKr,
          nameRU: titleRu,
          nameUZ: titleUz,
      ...
      http
        .post("/api/user/addRegulationdocument", {
          hashId: arr?.at(-1),
          nameKR: titleKr,
          nameRU: titleRu,
          nameUZ: titleUz,
  ...
  const getData = () => {
    http
      .get("/api/public/allRegulationdocument")
      .then((res) => {
        console.log(res.data);
        setAlldata(res.data);
      })
  ...
  const deleteData = (id) => {
    http
      .delete(`/api/user/deleteRegulationdocument/${id}`)
      .then((res) => {
        console.log(res.data);
        if (res.data?.success) {
        ...
        <Box sx={style}>
          ...
          <div className="elonimg">
            <label className="eloninput">
              ...
              <span>
                Faqat bitta fayl qushish mumkin. Fayl qushish majburiy
              </span>
            </label>
          </div>
