...
const IqtidorliTalabalar = () => {
  ...
  const handleSubmit = () => {
    ...
    if (edit) {
      http
        .put(`/api/user/editStudents/${editid}`, {
          hashId: arr?.at(-1),
          degreeKR: titleKr,
          degreeRU: titleRu,
          degreeUZ: titleUz,
  ...
  const deleteData = (id) => {
    http
      .delete(`/api/user/deleteStudent/${id}`)
      .then((res) => {
        console.log(res.data);
        if (res.data?.success) {
      ...
      >
        <Box sx={style}>
          ...
          <div className="elontitlewrapper">
            ...
            />
            <TextField
              onChange={(e) => setfullNameKr(e.target.value)}
              defaultValue={fullNameKr}
              className="elontitleinput"
              id="outlined-basic"
              label="fullNameKr"
              variant="outlined"
          ...
          <div className="elontitlewrapper">
            <TextField
              onChange={(e) => setdirectionUz(e.target.value)}
              defaultValue={directionUz}
              className="elontitleinput"
              id="outlined-basic"
              label="directionUz"
              variant="outlined"
            />
            <TextField
              onChange={(e) => setdirectionRu(e.target.value)}
              defaultValue={directionRu}
              className="elontitleinput"
              id="outlined-basic"
              label="directionRu"
              variant="outlined"
            />
            <TextField
              onChange={(e) => setdirectionEn(e.target.value)}
              defaultValue={directionEn}
              className="elontitleinput"
              id="outlined-basic"
              label="directionEn"
              variant="outlined"
            />
            <TextField
              onChange={(e) => setdirectionKr(e.target.value)}
              defaultValue={directionKr}
              className="elontitleinput"
              id="outlined-basic"
              label="directionKr"
              variant="outlined"
